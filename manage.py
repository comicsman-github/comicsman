...
UZANTILAR = set(['png','jpg','jpeg','rar','zip'])
                ...
                if result_alr == 0:
                    ...
                    if result_alr_em == 0:
                        ...
                        try:
                            ...
                            mail.ehlo()
                            mail.starttls()
                            mail.login("bberkaykaya0@gmail.com","eko54321")
            ...
            if result_second > 0:
                ...
                if result_control > 0:
                    ...
                    try:
                        ...
                        mail_gmail.starttls()
                        mail_gmail.ehlo()
                        mail_gmail.login("bberkaykaya0@gmail.com","eko54321")
...
def myprofile(id):
    ...
    if result > 0 and result_second > 0:
        ...
        dosya = user["imgname"]
        return render_template("profile.html",users = user,comics = comic,dosya = dosya)
    elif result > 0:
        user = cursor.fetchone()
        dosya = user["imgname"]
        ...
        if request.method == "POST" and form.validate():
            ...
            if result > 0:
                ...
                try:
                    ...
                    mail_gmail.starttls()
                    mail_gmail.ehlo()
                    mail_gmail.login("comicstheman@gmail.com","Ekox.54321")
                    mail_gmail.sendmail(mesaj["From"],mesaj["To"],mesaj.as_string())
                    mail_gmail.close()
                    if session["en"] == True and session["tr"] == False:
